...
export function LayoutControls() {
  const { themeMode, resolvedThemeMode, themePreset, contentLayout, navbarStyle, variant, collapsible, font } =
    usePreferencesStore(
      useShallow((s) => ({
        ...
        variant: s.sidebarVariant,
        collapsible: s.sidebarCollapsible,
        font: s.font,
      })),
    );
  const { setThemeMode, setThemePreset, setContentLayout, setNavbarStyle, setSidebarVariant, setSidebarCollapsible, setFont } =
    usePreferencesStore(
      useShallow((s) => ({
