 ...
 */
export function ensurePresent<T>(value: T | null | undefined, fieldName: string): T {
 ...
 */
export function validateRegex(value: string, regex: RegExp, fieldName: string): void {
  if (!regex.test(value)) {
